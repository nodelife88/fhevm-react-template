...
export function ContractDemo() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-6 space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>ConfidentialMessenger Contract</CardTitle>
          <CardDescription>
            Real contract integration with FHEVM encryption
          </CardDescription>
          <div className="flex gap-2">
            <Badge variant="outline">Connected: {address}</Badge>
            <Badge variant="outline">Chain: {chainId}</Badge>
            <Badge variant="default">Contract: {MESSENGER_ADDRESS}</Badge>
          </div>
        </CardHeader>
      </Card>
