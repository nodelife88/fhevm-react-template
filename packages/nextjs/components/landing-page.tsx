...
import { Shield, Lock, Users, MessageSquare, Key, Eye } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-xl font-semibold">FHEVM Messenger</span>
          </div>
      ...
      <section className="container mx-auto px-4 py-24 md:py-32">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Button size="lg" className="text-base px-8" onClick={() => setWalletModalOpen(true)}>
              Launch App
            </Button>
      ...
      <section id="features" className="container mx-auto px-4 py-24">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card className="p-6 space-y-4 bg-card border-border hover:border-primary/50 transition-colors">
            ...
            <h3 className="text-xl font-semibold">DAO Channels</h3>
            <p className="text-muted-foreground leading-relaxed">
              Create confidential group discussions within DAOs. Only verified members can decrypt and participate in
              conversations.
            </p>
          </Card>
          ...
          <Card className="p-6 space-y-4 bg-card border-border hover:border-primary/50 transition-colors">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Optional message publicization after DAO votes or timeouts. Transparent governance when needed.
            </p>
          </Card>
      ...
      <section className="container mx-auto px-4 py-24">
        <Card className="p-12 md:p-16 text-center space-y-6 bg-card border-border">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-sm">FHEVM Messenger</span>
            </div>
